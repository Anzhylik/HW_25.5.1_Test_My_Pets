...
def test_show_my_pets():
   ...
   pytest.driver.find_element(By.ID, 'email').send_keys('ram_ok@bk.ru')

   # Вводим пароль
   pytest.driver.find_element(By.ID, 'pass').send_keys('R_65406_Anzhela1103_M')
